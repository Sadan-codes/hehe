...
export const DEFAULT_LOVE_NOTES: LoveNote[] = [
  ...
  },
  {
    ...
    preview: 'Take a soft breath, my darling...',
    content: `My sweet girl,\n\nTake a slow, deep breath and let your shoulders drop. Today may have been overwhelming or unkind, but please remember that bad days do not define your incredible worth.\n\nYou handled everything with so much grace, even when it felt heavy. Now it's time to rest. Wrap yourself in the comfiest blanket, let go of the pressure, and remember that you have someone in your corner who believes in you unconditionally.\n\nI'm so proud of you, today and every day.`,
  ...
  },
  {
    ...
    content: `Hey beautiful!\n\nJust dropping by to remind you that out of 8 billion people on this planet, meeting you is the best thing that ever happened to me.\n\nAlso, your laugh is literally my favorite sound in the world, your hugs are the ultimate recharge station, and you are stuck with me forever! No refunds, no exchanges! 🥰`,
